...
def seed_database():
    ...
    nodes = [
        {
            ...
            "type": "equipment",
            "properties": {"location": "Area 3", "maintenance_interval": "30 days"},
        },
        {
            "tag": "V-20",
            "name": "Valve V-20",
            "type": "equipment",
            "properties": {"valve_type": "Flow Control"},
        },
        {
            "tag": "E-101",
    ...
    captures = [
        {
            "expert_name": "Senior Engineer Dave",
            "equipment_tag": "C-104",
            "knowledge_text": "C-104 bearing replaced on 2026-06-15 due to high vibration. Watch the intake pressure closely.",
        }
    ]
    ...
    for capture in captures:
        res = (
            ...
            .select("id")
            .eq("equipment_tag", capture["equipment_tag"])
            .execute()
        )
        if not res.data:
